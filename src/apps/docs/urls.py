...
urlpatterns = [
    ...
    path(
        "notificaciones/",
        login_required(NotificacionListView.as_view()),
        name="notificaciones_list",
    ),
    path(
        "notificaciones/<int:pk>/",
        login_required(NotificacionDetailView.as_view()),
        name="notificaciones_detail",
    ),
    path(
        "get_notification_recipients_count/",
        views.get_notification_recipients_count,
        name="get_notification_recipients_count",
    ),
    path("cmi-movil/ayuda/", views.CMIMovilView.as_view(), name="cmi_movil_help"),
]
